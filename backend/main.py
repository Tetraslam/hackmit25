...
# Energy sources configuration (matching dummy data generator for consistency)
ENERGY_SOURCES = [
    EnergySource(id="SOLAR_001", max_supply_amps=200.0, cost_per_amp=0.05, ramp_limit_amps=50.0),
    EnergySource(id="BATTERY_001", max_supply_amps=150.0, cost_per_amp=0.15, ramp_limit_amps=100.0),
    EnergySource(id="GAS_GEN_001", max_supply_amps=300.0, cost_per_amp=0.25, ramp_limit_amps=30.0),
    EnergySource(id="GRID_001", max_supply_amps=500.0, cost_per_amp=0.35, ramp_limit_amps=None),
    EnergySource(id="WIND_001", max_supply_amps=100.0, cost_per_amp=0.08, ramp_limit_amps=40.0),
    EnergySource(id="DIESEL_001", max_supply_amps=200.0, cost_per_amp=0.50, ramp_limit_amps=25.0),
]
