"""
Main Entry Point for Microgrid Optimization System
===================================================
This module provides the main entry point for running the microgrid optimizer.
It can run in different modes:
- Demo mode: Quick demonstration with dummy data
- Test mode: Run integration tests
- Real-time mode: Continuous operation at 24Hz

Usage:
    python main.py [demo|test|realtime]
...
def run_realtime_simulation():
    ...
    This simulates actual deployment where the optimizer:
    - Receives streaming data at 24Hz
    - Optimizes dispatch in real-time
    - Outputs dispatch instructions continuously
    """
    print("=" * 70)
